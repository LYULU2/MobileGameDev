...
public class MazeGenerator : MonoBehaviour {
    public float initalPositionX = 0;
    public float initalPositionY = 0;
    ...
    public void CreateLayout()
    {
        ...
        // Vector2 startPos = new Vector2(transform.position.x,transform.position.y); // transform the object current position in the scene to initialize
        Vector2 startPos = new Vector2(initalPositionX,initalPositionY); // user can modified the initial position of maze through two public float number
    ...
    public void MakeExit()
    {
        ...
        Cell newCell = edgeCells[edgeCells.Count-1];// fixed the exit on the top right (the last generated cell)
